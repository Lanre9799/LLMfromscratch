...
#Create Multihead attention with Keys, Query, Token and causal attention
...
inputs = torch.tensor(
    [[0.43, 0.15, 0.89, 0.55, 0.87, 0.66], #journey (X^2)
     [0.57, 0.85, 0.64, 0.22, 0.58, 0.33], # with (X^4)
     [0.77, 0.25, 0.10, 0.05, 0.80, 0.55]] # step (X^6)
)
